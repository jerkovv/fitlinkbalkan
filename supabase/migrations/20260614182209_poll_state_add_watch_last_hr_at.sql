-- athlete_poll_state: dodat watch_last_hr_at u workout payload (telefon hrani watch-presence i
-- iz poll-a, ne samo realtime-a). Version-control only: vec primenjeno u bazi preko MCP-a.
