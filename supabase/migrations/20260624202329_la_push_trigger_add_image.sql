...
BEGIN
  ...
  -- restEndsAt SAMO u pauzi. ActivityKit dekodira Date kao sekunde od 2001, NE od 1970.
  ...
  -- imageFileName = sha256_lowercase_hex(thumbnail_url) + ".png" (isto kao Swift).
  -- Ekstenzija ucita kesirani fajl iz App Group; fajl mora vec biti tu (pred-kesiranje).
  SELECT e.thumbnail_url INTO v_thumb_url
  FROM public.exercises e
  WHERE e.name = NEW.current_exercise_name
  LIMIT 1;
